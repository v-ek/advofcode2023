    ...
    for col_index in range(width := len(line)): 
        ...
        if char.isdigit():
            ...
            if char == ".":
                ...
                special_char_coordinates.add(curr_coordinates)
...
for number, coordinates in numbers_w_neighborhoods:
    if coordinates.intersection(special_char_coordinates):
        part_numbers_to_sum.append(number)

print(part_numbers_to_sum)
print(sum(part_numbers_to_sum))